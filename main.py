...
parser.add_argument('--data_path', type = str, default = '/localtmp/data/CUB_200_2010',
...
parser.add_argument('--lr_rampdown_epochs', default=110, type=int, metavar='EPOCHS',
